...
<p style="text-align:left; font-size:2em; color: #C8CAC9; padding:15px"><a href=https://www.youtube.com/watch?v=mclucQL9egU target="_blank">&emsp;<span style="text-align:left; font-size:1em; color: #C8CAC9">킹덤&emsp;</span></a>
   ...
   <p style = "font-size:1em; line-height:1.5em; color : white;">
   ...
   <br><br><p style = "font-size:1em; line-height:1.5em; color : white;">
      ...
      <br><p style = "font-size:1em; line-height:1.5em; color : white;">왕의 비밀을 품은 강녕전 <span style = "color: #C8CAC9">경희궁</span></p>
   ...
   <p style = "font-size:1em; line-height:1.5em; color : white;"><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
...
숭정전을 지나 경희궁 가장 안쪽으로 들어서면 기이한 모양의 바위를 볼 수 있다. ‘서암’으로 불리며, 왕의 기운이 서렸다는 이야기가 전해진다. 드라마에서 세자 이창(주지훈)이 어린 시절 커다란 바위 아래 숨은 자신을 스승인 안현대감(허준호)이 찾아내 안아준 추억을 회상하는 장면이 있는데, 이때 어린 창이 숨은 바위가 바로 이곳이다.
    ...
    <div id="example1"><font style="font-size:1em; line-height:1.5em; color : white;">
   ...
   <br><p style = "font-size:1em; line-height:1.5em; color : white;">새로운 <킹덤> 시리즈의 기대를 품다<span style = "color: #C8CAC9"> 종묘</span></p>
    <br><br><img src="resources/img/tab_3_4_3_1.jpg" style= "float:left; margin-right: 20px; margin-bottom: 10px; " /><br>      
    <p style = "font-size:1em; line-height:1.5em; color : white;"><br><br><br><br>
    ...
    <p>홈페이지&nbsp; <a href="http://jm.cha.go.kr/agapp/main/index.do?siteCd=JM"><span style = "color: white">http://jm.cha.go.kr/</span></a></p>    
    </font></div><br><br>
    <hr color = "#C8CAC9"> 
       
       
       
             <br><p style = "font-size:1em; line-height:1.5em; color : white;">자연 그대로의 아름다움을 간직한 <span style = "color: #C8CAC9">창덕궁</span></p>
...
※ 창덕궁 관람 해설은 현재 신종 코로나바이러스 감염증 예방 및 방지를 위하여 잠정 운영 중단되었다
    ...
    <p>홈페이지&nbsp; <a href="http://www.cdg.go.kr/default.jsp"><span style = "color: white">http://www.cdg.go.kr/</span></a></p>    
    </font></div><br><br>
    <hr color = "#C8CAC9">
       
     
         <br><p style = "font-size:1em; line-height:1.5em; color : white;">밤에 더욱 아름다운 <span style = "color: #C8CAC9">창경궁</span></p>
       ...
       <img src="resources/img/tab_3_4_5_3.JPG" style= "float:left; margin-left: 10px; margin-right: 10px; margin-bottom: 10px; " />   <br><br><br><br><br><br>
         <p style = "font-size:1em; line-height:1.5em; color : white;"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
    ...
    <p>홈페이지&nbsp; <a href="http://cgg.cha.go.kr/agapp/main/index.do?siteCd=CGG"><span style = "color: white">http://cgg.cha.go.kr/agapp/</span></a></p> 
    </font></div><br><br>
    <hr color = "#C8CAC9">
       
       
       
    <br><p style = "font-size:1em; line-height:1.5em; color : white;">조선 왕실의 모든 것 <span style = "color: #E7DDBC">국립고궁박물관</span></p>
     <br><br>   
   ...
   <p style = "font-size:1em; line-height:1.5em; color : white;">
    ...
    <p>홈페이지&nbsp; <a href="https://www.gogung.go.kr/main.do"><span style = "color: white">https://www.gogung.go.kr/</span></a></p> 
    </font></div><br><br>
    <hr color = "#C8CAC9">
